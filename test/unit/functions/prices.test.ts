...
import { CurrencyAmount, JSBI, Token, TradeType } from 'gravityswap_core-sdk' //'@sushiswap/core-sdk'
import { Pair, Route, Trade } from 'gravityswap_core-sdk' //'@sushiswap/core-sdk'

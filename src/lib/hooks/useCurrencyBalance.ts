...
import { Currency, CurrencyAmount, JSBI, NATIVE, Token } from 'gravityswap_core-sdk' //'@sushiswap/core-sdk'
  ...
  return useMemo(
    () =>
      validAddressInputs.reduce<{ [address: string]: CurrencyAmount<Currency> }>((memo, [address], i) => {
        ...
        if (value && chainId)
          memo[address] = CurrencyAmount.fromRawAmount(NATIVE[chainId], JSBI.BigInt(value.toString())) // @todo: change hardcode
        return memo
      }, {}),

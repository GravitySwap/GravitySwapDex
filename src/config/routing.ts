...
import { GRAVITY, SUSHI, Token, WNATIVE } from 'gravityswap_core-sdk' //'gravityswap_core-sdk' //'@sushiswap/core-sdk'
...
export const PINNED_PAIRS: { readonly [chainId: number]: [Token, Token][] } = {
  ...
  [ChainId.SEPOLIA]: [
    // @ts-ignore TYPE NEEDS FIXING
    [GRAVITY[ChainId.SEPOLIA], WNATIVE[ChainId.SEPOLIA]],
    [SEPOLIA.GRAVITY, SEPOLIA.USDC],
    [SEPOLIA.WETH, SEPOLIA.GRAVITY],
  ],
}

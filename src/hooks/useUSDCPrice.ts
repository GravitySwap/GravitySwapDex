...
import { Currency, CurrencyAmount, Price, Token, USD } from 'gravityswap_core-sdk' //'@sushiswap/core-sdk'
...
export const STABLECOIN_AMOUNT_OUT: { [chainId: number]: CurrencyAmount<Token> } = {
  ...
  [ChainId.SEPOLIA]: CurrencyAmount.fromRawAmount(USD[ChainId.SEPOLIA], 100_000e6),
  // [ChainId.BLAST]: CurrencyAmount.fromRawAmount(USD[ChainId.BLAST], 100_000e6),

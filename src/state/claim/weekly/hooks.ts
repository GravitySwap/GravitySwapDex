...
import { Currency, CurrencyAmount, JSBI, SUSHI } from 'gravityswap_core-sdk' //'@sushiswap/core-sdk'
...
export function useUserUnclaimedAmount(account: string | null | undefined): CurrencyAmount<Currency> | undefined {
  ...
  const isCustomeChain = chainId && getCustomChainIds().includes(chainId)
  const sushi = chainId && !isCustomeChain ? SUSHI[chainId as ChainId as keyof typeof SUSHI] : undefined

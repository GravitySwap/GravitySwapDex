...
import {
  ...
  TradeType,
  WNATIVE_ADDRESS,
} from 'gravityswap_core-sdk' //'@sushiswap/core-sdk'
...
const BAD_RECIPIENT_ADDRESSES: { [chainId: string]: { [address: string]: true } } = {
  [ChainId.ETHEREUM]: {
    '0x5FbDB2315678afecb367f032d93F642f64180aa3': true, // '0xC0AEe478e3658e2610c5F7A4A2E1777cE9e4f2Ac': true, // v2 factory
    '0xCf7Ed3AccA5a467e9e704C703E8D87F634fB0Fc9': true, // '0xd9e1cE17f2641f24aE83637ab66a2cca9C378B9F': true, // v2 router 02
  },
}

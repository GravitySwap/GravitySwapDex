        ...
        <div className="flex flex-col justify-between p-5 space-y-3 sm:space-y-0 sm:flex-row">
          <div className="flex items-center w-full sm:w-2/5">
            <div className="flex items-center gap-4">
              <Image
                src={
                  currency === GRAVITY[ChainId.SEPOLIA]
              ...
              <div className="flex flex-col items-start">
                ...
                {(currency === GRAVITY[ChainId.SEPOLIA] || currency === XGRAVITY) && (
                  <Typography
                    variant="xs"
                    className="underline cursor-pointer text-blue"
                    // // @ts-ignore TYPE NEEDS FIXING
                    onClick={() => setCurrency(currency === XGRAVITY ? GRAVITY[ChainId.SEPOLIA] : XGRAVITY, field)}
                    //onClick={() => setCurrency(currency === XSUSHI ? SUSHI[ChainId.ETHEREUM] : XSUSHI, field)}
                  >
                    {currencies[field] === GRAVITY[ChainId.SEPOLIA] ? i18n._(t`Use xGRAVITY`) : i18n._(t`Use GRAVITY`)}

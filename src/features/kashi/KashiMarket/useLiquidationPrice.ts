...
import { Currency, CurrencyAmount, Price, Trade as LegacyTrade, TradeType, ZERO } from 'gravityswap_core-sdk' //'@sushiswap/core-sdk'

interface Payload {
  borrowAmount?: CurrencyAmount<Currency>
  collateralAmount?: CurrencyAmount<Currency>
  trade?: LegacyTrade<Currency, Currency, TradeType.EXACT_INPUT> | null | undefined
  invert: boolean
  reduce: boolean
}

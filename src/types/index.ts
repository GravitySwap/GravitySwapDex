...
import { Currency, CurrencyAmount, Token, Trade as LegacyTrade, TradeType } from 'gravityswap_core-sdk' //'@sushiswap/core-sdk'
import { PoolState, Trade } from 'gravityswap_trident-sdk' //'@sushiswap/trident-sdk'

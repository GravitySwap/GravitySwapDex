...
const { ChainId } = require('gravityswap_core-sdk') //'gravityswap_core-sdk/core-sdk'
...
const nextConfig = {
  ...
  // },
  // images: {
  //   domains: ['app.sushi.com']
  // }
  images: {
    domains: ['app.sushi.com', 'res.cloudinary.com', 'raw.githubusercontent.com', 'logos.covalenthq.com', 'github.com'],
  },
